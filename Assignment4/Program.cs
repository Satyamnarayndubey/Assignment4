// Program 1: Create a class representing a bank account with a balance property. Implement a property validation that prevents the balance from going negative. 
using System;
...

    {
...

        {
            ...
            case ShapeType.Triangle:
                double triangleBase = 6.0; double triangleHeight = 8.0;
